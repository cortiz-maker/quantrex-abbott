...
// Pines estilo DispatchTrack (círculo de color con ícono/número adentro y
// una "colita" apuntando al punto exacto), en vez de los circleMarker planos
// que se usaban antes. Reutilizado por ambos mapas de trazabilidad.
function pinIcon(contenido, color, size = 30) {
  return L.divIcon({
    className: "",
    html: `<div style="position:relative;width:${size}px;height:${size}px;">
      <div style="width:${size}px;height:${size}px;border-radius:50% 50% 50% 0;background:${color};transform:rotate(-45deg);border:2px solid #fff;box-shadow:0 2px 6px #00000055;"></div>
      <div style="position:absolute;top:0;left:0;width:${size}px;height:${size}px;display:flex;align-items:center;justify-content:center;font-size:${size*0.5}px;font-weight:800;color:#fff;">${contenido}</div>
    </div>`,
    iconSize: [size, size],
...
const LOGO_QUANTREX_LOADER = "data:image/png;base64,";
...
async function calcularTramo(origen, destino) {
  try {
    const res = await fetch(`${QUANTREX_DT_BRIDGE_URL}/api/maps/distance-matrix?origins=${encodeURIComponent(origen)}&destinations=${encodeURIComponent(destino)}`, {
      headers: { "x-puente-token": QUANTREX_DT_BRIDGE_TOKEN },
    });
...
async function snapToRoads(puntos){
  ...
  try{
    for(let i=0;i<puntos.length;i+=CHUNK){
      ...
      const res = await fetch(`${QUANTREX_DT_BRIDGE_URL}/api/maps/snap-to-roads?path=${encodeURIComponent(path)}`, {
        headers: { "x-puente-token": QUANTREX_DT_BRIDGE_TOKEN },
      });
      if(!res.ok) return null;
      const data = await res.json();
...
function MapaTrazabilidadHoy(){
  ...
  useEffect(()=>{
    ...
    datosMapa.grupos.forEach((grupo,gi)=>{
      ...
      const inicio=grupo[0], fin=grupo[grupo.length-1];
      L.marker([inicio.lat,inicio.lng],{icon:pinIcon("🚚","#22C55E")})
        .bindPopup(`<b>Inicio</b><br/>${inicio.vehiculo_id||"Vehículo"}<br/>${fmtHora(inicio.timestamp_captura)}`)
        .addTo(map);
      L.marker([fin.lat,fin.lng],{icon:pinIcon("📍","#E11D48")})
    ...
    datosMapa.paradas.slice(0,15).forEach((pa,i)=>{
      L.marker([pa.lat,pa.lng],{icon:pinIcon(i+1,"#F59E0B",26)})
  ...
  return(
    <div style={S.section}>
      ...
      {!buscado?(
        ...
        <div style={S.loadingWrap}><img src={LOGO_QUANTREX_LOADER} alt="" style={S.logoSpinner}/><p style={{color:C.muted}}>Cargando trazabilidad...</p></div>
      ):puntos.length===0?(
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:12,padding:"40px 0",color:C.muted}}>
          <div style={{fontSize:36}}>·</div>
